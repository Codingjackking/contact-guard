...
// ---------------------------------------------------------------------------
export function xorCipher(str, key) {
  const out = [];
...
export function xorDecipher(charCodes, key) {
  return charCodes
...
export function fromCharArray(arr) {
...
// ---------------------------------------------------------------------------
export function encode(plaintext, xorKey) {
...
export function decode(encoded, xorKey) {
  if (!xorKey) throw new Error("[contact-guard] xorKey is required");
  try {
